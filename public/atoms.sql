...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3009895439ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=atom&table=atoms">`atom`.`atoms`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=school&table=answers">`school`.`answers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=school&table=results">`school`.`results`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=school&table=questions">`school`.`questions`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blog&table=categories">`blog`.`categories`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=movie_app&table=users">`movie_app`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="584d276d77536a734028737c3b417d59">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="atom" targettable="atoms">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `atoms`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="atom" targettable="atoms">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `atoms`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="school" targettable="questions">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `questions`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="school" targettable="answers">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `answers`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="school" targettable="answers">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `answers`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="school" targettable="results">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `results`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="school" targettable="results">
                            <div class="action_content">
