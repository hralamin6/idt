<div class="capitalize">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        <div class=" flex gap-3 bg-white border dark:border-gray-600 dark:bg-darkSidebar px-4 py-2 rounded-md">
            <div class="flex flex-row gap-2 text-sm text-purple-500 font-semibold dark:text-purple-200">
                ...
                <p class=""><?php echo e(number_format(auth()->user()->avgpoint(), 2)); ?></p>
            </div>
        </div>
        <div class=" flex gap-3 bg-white border dark:border-gray-600 dark:bg-darkSidebar px-4 py-2 rounded-md">
    ...
    <div class="flex items-center justify-center m-2">
        <span class="text-gray-500 dark:text-white capitalize"><?php echo app('translator')->get('points according to tasks'); ?></span>
    </div>
    <div class="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        <div class=" flex gap-3 bg-white border dark:border-gray-600 dark:bg-darkSidebar px-4 py-2 rounded-md">
            <a href="<?php echo e(route('taskwise', $item->id)); ?>" class="flex flex justify-between gap-2 text-sm text-indigo-500 font-semibold dark:text-indigo-200">
