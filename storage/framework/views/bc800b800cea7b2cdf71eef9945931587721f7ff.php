...
<?php endif; ?>
        ...
        <div
            ...
            :class="{'hidden': search}">
            <a href="<?php echo e(route('home')); ?>" class="cursor-pointer mt-1.5 <?php echo e(Route::is('home')?'text-purple-600 dark:text-purple-300':''); ?>">
                <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = $__env->getContainer()->make(BladeUI\Icons\Components\Svg::class, [] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
            ...
            <a href="<?php echo e(route('users')); ?>" class="cursor-pointer mt-1.5 <?php echo e(Route::is('users')?'text-purple-600 dark:text-purple-300':''); ?>">
                <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = $__env->getContainer()->make(BladeUI\Icons\Components\Svg::class, [] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('h-o-users'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php endif; ?>
            ...
            <a href="<?php echo e(route('task.monthly')); ?>" class="cursor-pointer mt-1.5 <?php echo e(Route::is('task.monthly')?'text-purple-600 dark:text-purple-300':''); ?>">
                <?php if (isset($component)) { $__componentOriginalcd9972c8156dfa6e5fd36675ca7bf5f21b506e2e = $component; } ?>
<?php $component = $__env->getContainer()->make(BladeUI\Icons\Components\Svg::class, [] + (isset($attributes) ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('h-o-calendar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php endif; ?>
            ...
            <a class="w-8 h-8 <?php echo e(Route::is('profile')?'bg-purple-600 dark:bg-purple-300':''); ?>" href="<?php echo e(route('profile')); ?>"><img class="object-cover rounded-full"
                                                src="https://www.gravatar.com/avatar/<?php echo e(md5(auth()->user()->email)); ?>?d=mp"
