        ...
        <li class="border-gray-400 flex flex-row mb-2">
            <div class="shadow border select-none cursor-pointer bg-white dark:bg-gray-800 rounded-md flex flex-1 space-x-3 items-center p-4">
                ...
                <div class="flex flex-col gap-2">
                    <div class="text-gray-600 dark:text-gray-200 text-sm"><?php echo app('translator')->get('total point:'); ?> <?php echo e($user->point()); ?></div>
                    <div class="text-gray-600 dark:text-gray-200 text-xs"><?php echo app('translator')->get('average point:'); ?> <?php echo e($user->avgpoint()); ?></div>
                </div>
            </div>
        </li>
